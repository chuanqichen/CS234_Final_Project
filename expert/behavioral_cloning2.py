...
import numpy as np
import pandas as pd
from network_utils import NetworkBC, MultiLayerCNN, np2torch, device
from environment import Environment
import matplotlib.pyplot as plt


# All observations, for reference
    ...
    for filepath_obs in combined_filepaths:
        ...
        try:
            ...
            if TRAINING_MODE == "pick":
                df_obs = df_obs[df_obs["subtask_id"] in [2]]
                ## df_imgs = df_imgs[df_imgs["subtask_id"] <= 4]
            elif TRAINING_MODE == "place":
                df_obs = df_obs[df_obs["subtask_id"] in [6]]
                ## df_imgs = df_imgs[df_imgs["subtask_id"] > 4]
