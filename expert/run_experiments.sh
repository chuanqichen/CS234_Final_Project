CUDA_VISIBLE_DEVICES=0 python td3_with_obs.py --dirpath "test100" --filename "td3_fixed" --operation "both" --pi_arch 300, 200,100 --qf_arch 300,200,100 --max_timesteps 10000000 &
